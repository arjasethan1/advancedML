...
#
#        best_thread = pairwise_distances_argmin(question_vec.reshape(1, self.embeddings_dim), thread_embeddings, metric = 'cosine') #### YOUR CODE HERE ####
#        print('thread_ids[best_thread]: ', thread_ids[best_thread].shape)
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        #### YOUR CODE HERE ####
        ########################
        self.chitchat_bot = ChatBot('felixdae',
